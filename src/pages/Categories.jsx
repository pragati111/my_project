...
export default function Categories() {
  ...
  return (
    <>
      ...
      <div className="mt-16 flex h-[calc(100vh-64px)] bg-gradient-to-br from-white via-gray-50 to-gray-100">
        ...
        <div className="w-[22%] min-w-[120px] max-w-[220px] flex-shrink-0 p-3 overflow-y-auto backdrop-blur-xl bg-white/70 border-r border-gray-200 shadow-xl z-10">
          ...
          {categories.map((cat, index) => (
            <motion.div
              ...
              className={`relative mb-3 px-3 py-2 rounded-xl cursor-pointer transition-all duration-300 flex items-center gap-2 w-full ${
                activeIndex === index
            ...
            >
              ...
              {/* ICON */}
              <div className="w-8 h-8 flex items-center justify-center rounded-full bg-gray-100 shrink-0">
                <img
              ...
              {/* NAME */}
              <span className="text-[8px] font-medium leading-tight break-words w-full">
                {cat.name}
              </span>
            </motion.div>
          ))}
        ...
        {/* RIGHT CONTENT */}
        <div className="w-[78%] overflow-y-auto p-6 space-y-12">
          {categories.map((cat, i) => (
            ...
            >
              <motion.h2
                ...
                className="text-2xl font-bold mb-6 text-gray-800 tracking-tight"
              >
                {cat.name}
              </motion.h2>
  ...
  >
    ...
    <div className="px-2 py-2">
      <p className="text-[7px] text-gray-800 text-center leading-tight break-words">
        {item.name}
      </p>
    </div>
  </motion.div>
