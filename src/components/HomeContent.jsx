    ...
    <div className="space-y-6">
      ...
      <div className="px-4 md:px-8">
        <div className="relative bg-gray-100 rounded-xl overflow-hidden">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white/80 px-4 md:px-8 py-3 md:py-6 rounded-lg shadow">
      ...
      <div className="px-4 md:px-8 pb-6">
        <div className="bg-gray-100 rounded-xl p-4 md:p-6 grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
...
function Feature({ title, subtitle }) {
  return (
    <div className="flex items-center gap-3">
      <div className="w-8 h-8 md:w-10 md:h-10 bg-orange-100 rounded-lg"></div>
      <div>
